...
func init() {
	...
	RootCmd.PersistentFlags().BoolP("allow-partial-signature", "", false, "Allow signing with only a subset of the keys required by a transaction. NOTE: Without all required signatures, a transaction might fail authorization checks immediately.")
